    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      `}>
        <div className="flex flex-col h-full">
          {/* Sidebar Header */}
          <div className="relative px-6 py-6 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
            <button
              onClick={() => setSidebarOpen(false)}
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center shadow-lg">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-white truncate">{user?.name}</p>
                  <p className="text-xs text-gray-300 font-medium tracking-wide uppercase" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Administrator
                  </p>
                </div>
              </div>
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    `}>
                      <Icon className={`w-5 h-5 ${active ? 'text-white' : 'text-gray-600 group-hover:text-gray-900'}`} />
                    </div>
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500">
                  {navigationItems.find(item => isActive(item.path))?.description || 'Manage system'}
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden md:flex items-center gap-3 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-100 to-gray-200 border border-gray-300">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-700 font-medium tracking-wide uppercase" style={{ fontFamily: "'Playfair Display', serif" }}>
                      Administrator
                    </p>
                  </div>
                </div>
